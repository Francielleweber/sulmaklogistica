...
app.post('/login', (req, res) => {
  ...
  const USERS = {
    ...
    'Jordan@sulmak':        { pass: 'j6056',    filial: 'Porto Alegre',       isAdmin: false },
    'Murilo@sulmak':        { pass: 'm9013',    filial: 'Porto Alegre',       isAdmin: false },
    'Raupp@sulmak':        { pass: 'r5071',    filial: 'Porto Alegre',       isAdmin: false },
    'Renato@sulmak':        { pass: 'r0087',    filial: 'Porto Alegre',       isAdmin: false },
    'Mauricio@sulmak':        { pass: 'm6073',    filial: 'Porto Alegre',       isAdmin: false },
    'Gabriel@sulmak':        { pass: 'g7057',    filial: 'Porto Alegre',       isAdmin: false },
    'LeonardoR@sulmak':        { pass: 'l6060',    filial: 'Porto Alegre',       isAdmin: false },
    'LeonardoM@sulmak':        { pass: 'l3096',    filial: 'Porto Alegre',       isAdmin: false },
    'Felipe@sulmak':        { pass: 'f9014',    filial: 'Porto Alegre',       isAdmin: false },
    'Leandro@sulmak':        { pass: 'l6099',    filial: 'Porto Alegre',       isAdmin: false },
    'Daniel@sulmak':        { pass: 'd6015',    filial: 'Porto Alegre',       isAdmin: false },
    'Banny@sulmak':        { pass: 'b2087',    filial: 'Porto Alegre',       isAdmin: false },
    ...
    'Aislan@sulmak': { pass: 'a6055',     filial: 'Passo Fundo',        isAdmin: false },
    'Marcelo@sulmak': { pass: 'm0390',     filial: 'Passo Fundo',        isAdmin: false },
    'matogrosso': { pass: 'sulmak@ms',     filial: 'Mato Grosso do Sul', isAdmin: false },
    'Cris@sulmak': { pass: 'c0020',     filial: 'Mato Grosso do Sul', isAdmin: false },
